...
#test
testArray = ECG.nextbatch_limitperclasssize(47, 5)


tempx = np.concatenate((testArray[0][1:5], testArray[0][6:9]), axis = 0)
tempy = np.concatenate((testArray[1][1:5], testArray[1][6:9]), axis = 0)

testArray = (tempx, tempy)
