...
%------ SPECIFY DATA ------------------------------------------------------
%------ 指定数据文件 -------------------------------------------------------
PATH= '/Users/chen/Desktop/ecg/www.physionet.org/physiobank/database/mitdb'; % 指定数据的储存路径
HEADERFILE= '105.hea';      % .hea 格式，头文件，可用记事本打开
ATRFILE= '105.atr';         % .atr 格式，属性文件，数据格式为二进制数
DATAFILE='105.dat';         % .dat 格式，ECG 数据
SAMPLES2READ=2691;          % 指定需要读入的样本数
                            % 若.dat文件中存储有两个通道的信号:
