...
#tempx = np.append(sampleArray[0][1:4,:], )
tempx = np.concatenate((sampleArray[0][1:5], sampleArray[0][6:9]), axis = 0)
tempy = np.concatenate((sampleArray[1][1:5], sampleArray[1][6:9]), axis = 0)

sampleArray = (tempx, tempy)
#print(sampleArray[0])
#comp1 = 0
#comp2 = 1
#print(sampleArray[1])
...
#test
testArray = ECG.nextbatch_limitperclasssize(47, 30)

tempx2 = np.concatenate((testArray[0][17:22], testArray[0][44:50]), axis = 0)
tempy2 = np.concatenate((testArray[1][17:22], testArray[1][44:50]), axis = 0)

testArray = (tempx2, tempy2)
print(testArray)
